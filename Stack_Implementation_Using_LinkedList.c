...
int main()
{
    ...
    if(isEmpty(&stack)==0)
    {
        struct Node* successor = Successor(&stack, Search(&stack, 9));    ///Immediate Greater than 9
        struct Node* predecessor = Predecessor(&stack, Search(&stack, 9));    ///Immediate smaller than 9
